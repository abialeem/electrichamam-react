...
export default function Home(){
    const words = ["AC", "radiator", "room heater", "stone hamam"];
    return (
        <>
         ...
         <Hero />
          ...
          <section class="container mb-8 mb-lg-13" id="about">
            <div class="row align-items-center">
              <div class="col-12 col-lg-6 col-xl-7"><img class="img-fluid" src={process.env.PUBLIC_URL + "/images/Hero/Team.webp"} alt="" /></div>
              <div class="col-12 col-lg-6 col-xl-5">
                <div class="row justify-content-center justify-content-lg-start">
                  <div class="col-sm-10 col-md-8 col-lg-12">
                    <h2 class="fs-4 fs-lg-3 fw-bold mb-2 text-center text-lg-start">We Know What You Are Thinking?</h2>
                  ...
                  <div class="col-12">
                    <div class="mb-x1 mb-lg-3">
                      <h5 class="fs-4 fw-bold lh-lg mb-1 text-primary" >Why Electric Hamam ?</h5>
                    
                      <h5 class="fs-8 fw-bold lh-lg mb-1"><TypingAnimation words={words} speed={100} /></h5>
          ...
          <section class="container mb-8 mb-lg-13">
            <div class="row align-items-center">
              <div class="col-12 col-lg-6 col-xl-5 order-lg-1"><img class="img-fluid" src={process.env.PUBLIC_URL + "/images/Hero/Collaborator.webp"} alt="" /></div>
          ...
          <section class="experience position-relative overflow-hidden" id="service">
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-12">
                  <div class="position-relative z-1 text-center mb-8 mb-lg-9 video-player-paused" data-video-player-container="data-video-player-container"><video class="w-100 h-100 rounded-4" src="assets/video/Tech_video.mp4" poster={process.env.PUBLIC_URL + "/images/Hero/experiences.webp"} type="video/mp4" data-video-player="data-video-player"></video>
                    <div class="overlay position-absolute top-0 bottom-0 start-0 end-0 rounded-4 bg-1100 object-cover" data-overlay="data-overlay"> </div><button class="btn play-button position-absolute justify-content-center align-items-center bg-white rounded-circle cursor-pointer" data-play-button="data-play-button"> <img class="play-icon w-25" src={process.env.PUBLIC_URL + "/images/illustrations/play-solid.svg"} alt="" data-play-icon="data-play-icon" /><img class="pause-icon w-25" src={process.env.PUBLIC_URL + "/images/illustrations/pause-solid.svg"} alt="" data-pause-icon="data-pause-icon" /></button>
                    <div class="position-absolute dots d-none d-sm-block"><img class="img-fluid w-100" src={process.env.PUBLIC_URL + "/images/illustrations/Dots.webp"} alt="" /></div>
                  </div>
                </div>
                <div class="col-md-8 col-lg-7">
                ...
                <div class="col-12">
                  <div class="row gy-4 g-md-3 pb-8 pb-lg-11 px-1">
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={process.env.PUBLIC_URL + "/images/icons/roadmap.svg"} alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={process.env.PUBLIC_URL + "/images/icons/users-wm.svg"} alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={process.env.PUBLIC_URL + "/images/icons/share-91.svg"} alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={process.env.PUBLIC_URL + "/images/icons/video_meeting.svg"} alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={process.env.PUBLIC_URL + "/images/icons/opening-times.svg"} alt="" />
                      <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 d-flex align-items-start gap-2"><img src={process.env.PUBLIC_URL + "/images/icons/card-favorite.svg"} alt="" />
                      <div>
            ...
            <div class="position-absolute top-0 start-0 end-0">
              <div class="bg-white py-3 py-md-9 py-xl-10"> </div><img class="wave" src={process.env.PUBLIC_URL + "/images/illustrations/Wave_2.svg"} alt="" />
            </div>
          </section>
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-1">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src={process.env.PUBLIC_URL + "/images/feedback/reviewer_1.webp"} alt="" /></div>
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-2">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src={process.env.PUBLIC_URL + "/images/feedback/reviewer_2.webp"} alt="" /></div>
                                <div class="text-center text-lg-start">
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-3">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src={process.env.PUBLIC_URL + "/images/feedback/reviewer_3.webp"} alt="" /></div>
                                <div class="text-center text-lg-start">
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-4">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src={process.env.PUBLIC_URL + "/images/feedback/kakashi.webp"} alt="" /></div>
                                <div class="text-center text-lg-start">
                          ...
                          <div class="col-12 swiper-slide">
                            <div class="d-flex justify-content-center gap-2">
                              <div class="d-flex flex-column flex-lg-row gap-2 px-4 py-x1 review-card-5">
                                <div class="text-center text-lg-start"><img class="card-image rounded-circle object-fit-cover" src={process.env.PUBLIC_URL + "/images/feedback/obito.webp"} alt="" /></div>
                                <div class="text-center text-lg-start">
                ...
                <div class="col-lg-6">
                  <div class="accordion mt-lg-4 ps-3 pe-x1 bg-white" id="accordion">
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading1"><button class="accordion-button fs-8 lh-lg fw-bold pt-x1 pb-2" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1" data-accordion-button="data-accordion-button">How to setup BrainwaveIO?</button></h2>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading2"><button class="accordion-button fs-8 lh-lg fw-bold pt-x1 pb-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse2" aria-expanded="false" aria-controls="collapse2" data-accordion-button="data-accordion-button">Can I use BrainwaveIO for my clients?</button></h2>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading3"><button class="accordion-button fs-8 lh-lg fw-bold pt-x1 pb-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3" data-accordion-button="data-accordion-button">How often do you release update?</button></h2>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading4"><button class="accordion-button fs-8 lh-lg fw-bold pt-x1 pb-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4" data-accordion-button="data-accordion-button">How can I access to old version?</button></h2>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="heading5"><button class="accordion-button fs-8 lh-lg fw-bold pt-x1 pb-2 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5" data-accordion-button="data-accordion-button">How can I get your support?</button></h2>
          ...
          <section class="bg-300 position-relative z-0" id="contact">
            ...
            <div class="position-absolute bottom-0 end-0 z-n1 d-none d-lg-block"><img src={process.env.PUBLIC_URL + "/images/illustrations/Green_dots.svg"} alt="" /></div>
            <div class="position-relative bottom-0 start-0 z-1"><img class="img-fluid w-100" src={process.env.PUBLIC_URL + "/images/illustrations/Wave_3.svg"} alt="" /></div>
          </section>
        </div>
        <button class="btn scroll-to-top text-white rounded-circle d-flex justify-content-center align-items-center bg-primary" data-scroll-top="data-scroll-top">
...
//     if (!deleting && text.length === words[wordIndex].length) {
//       deleting = true;
//     }

//     text = deleting ? words[wordIndex].substring(0, text.length - 1) : words[wordIndex].substring(0, text.length + 1);
//     typingElement.textContent = text;

//     setTimeout(typeWords, deleting ? 150 : 150);
//   }
